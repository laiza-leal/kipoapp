# kipoapp
Projeto de App de Despensa Digital para a disciplina de Mobile
-------------------------------------------------------------
...
| **Anne** | Desenvolvimento da funcionalidade de Adicionar Item por Código de Barras, incluindo leitura do código, cadastro automático de produtos e integração da funcionalidade às demais telas. | _(adicionar link)_ |
...
| **Diogo Bastos** | Desenvolvimento das telas de Login, Cadastro e Recuperação de Senha, incluindo autenticação de usuários, validação de formulários, integração com Firebase e controle de acesso ao aplicativo. | https://drive.google.com/file/d/11DQ7Y5-8Bupml1SfYwXUzRN2pVlUoFaI/view?usp=sharing |
